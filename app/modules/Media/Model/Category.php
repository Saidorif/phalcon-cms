...
{
    protected $translateModel = 'Media\Model\Translate\CategoryTranslate';
    ...
    {
        return CmsCache::getInstance()->get('media_category');
    }
    ...
    {
        return HOST_HASH . md5('Media\Model\Category; list; ' . serialize($params));
    }
