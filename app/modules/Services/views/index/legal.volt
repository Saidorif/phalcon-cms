  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-8 tender-posts">
        ...
        <div class="content"> 
          {% for key, items in legals %}
            {% if key == 'must' %} <h2 class="mb-2">{{helper.translate('Must type services')}}</h2> {% endif %}
            {% if key == 'optional' %} <h2 class="mb-2">{{helper.translate('Optional type services')}}</h2> {% endif %}
            {% for prt in items %}
              <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                <div class="panel panel-default">
                  <div class="panel-heading" role="tab" id="headingOne">
                    <h4 class="panel-title">
                      <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne-{{prt['id']}}" aria-expanded="false" aria-controls="collapseOne">{{prt['title']}}</a>
                    </h4>
                  </div> 
                  <div id="collapseOne-{{prt['id']}}" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                            ...
                            <div class="table-responsive">
                              <div class="media">
                                <div class="media-body">
                                  <h4 class="media-heading">{{prt['text']}}</h4>
                                </div>
                              </div>
                            </div>   
                          </div>
